...
<body data-spy="scroll" data-target="#navbar-example" data-offset="0">
     ...
     <div class="navigation">
          ...
          <nav id="scrollspy">
               <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                         <a class="nav-link get-in-touch" href="#contact">Get In Touch</a>
                    </li>
     ...
     <!-- HOME SECTION -->
     <section id="home" class="parallax-section d-flex">
          <div class="container">
               <div class="row home-thumb">
          ...
          <a class="fa fa-chevron-down scroll-chevron bounce" href="#about"></a>
     </section>
     ...
     <!-- CONTACT SECTION -->
     <section id="hire" class="parallax-section">
          <div class="container" id='contact-target'>
               <div class="row" id='hire-sect'>
